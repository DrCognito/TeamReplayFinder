...
def build_metadata(match_in) -> dict:
    ...
    for pb in picks_bans:
        pickban_template['cName'].append(pb['hero']['hero_name'])
    ...
    for pp in player_picks:
        ...
        pickban_template['playerHero'].append(pp['hero']['hero_name'])
        hero['unitName'] = pp['hero']['hero_name']
        hero['cName'] = pp['hero']['hero_name']
        if pp['side'] == 'dire':
            hero['entType'] = "DIRE"
...
res = build_metadata(test_json)
output = Path("E:/Python/StaticAnalysis/data/processing_draft/6701482389.json")
with open(output, "w") as f:
    dump(res, f)

arr = [{"type":"PicksAndBans","cName":["npc_dota_hero_visage","npc_dota_hero_dazzle","npc_dota_hero_chen","npc_dota_hero_viper","npc_dota_hero_puck","npc_dota_hero_tiny","npc_dota_hero_winter_wyvern","npc_dota_hero_death_prophet","npc_dota_hero_enigma","npc_dota_hero_tusk","npc_dota_hero_night_stalker","npc_dota_hero_marci","npc_dota_hero_lycan","npc_dota_hero_phoenix","npc_dota_hero_bane","npc_dota_hero_warlock","npc_dota_hero_rattletrap","npc_dota_hero_beastmaster","npc_dota_hero_bloodseeker","npc_dota_hero_spectre","npc_dota_hero_furion","npc_dota_hero_luna","npc_dota_hero_alchemist","npc_dota_hero_razor"],"eName":["CDOTA_Unit_Hero_Visage","CDOTA_Unit_Hero_Dazzle","CDOTA_Unit_Hero_Chen","CDOTA_Unit_Hero_Viper","CDOTA_Unit_Hero_Puck","CDOTA_Unit_Hero_Tiny","CDOTA_Unit_Hero_Winter_Wyvern","CDOTA_Unit_Hero_DeathProphet","CDOTA_Unit_Hero_Enigma","CDOTA_Unit_Hero_Tusk","CDOTA_Unit_Hero_NightStalker","CDOTA_Unit_Hero_Marci","CDOTA_Unit_Hero_Lycan","CDOTA_Unit_Hero_Phoenix","CDOTA_Unit_Hero_Bane","CDOTA_Unit_Hero_Warlock","CDOTA_Unit_Hero_Rattletrap","CDOTA_Unit_Hero_Beastmaster","CDOTA_Unit_Hero_Bloodseeker","CDOTA_Unit_Hero_Spectre","CDOTA_Unit_Hero_Furion","CDOTA_Unit_Hero_Luna","CDOTA_Unit_Hero_Alchemist","CDOTA_Unit_Hero_Razor"],"team":[2,3,2,3,2,3,3,2,2,3,2,3,2,3,3,2,2,3,2,3,2,3,2,3],"ID":[92,50,66,47,13,19,112,43,33,100,60,136,77,110,3,37,51,38,4,67,53,48,73,15],"isPick":[],"steamID":[76561198047011640,76561198114980808,76561198054420884,76561198085066985,76561197986172872,76561198100554096,76561198157143864,76561198057068811,76561198086478594,76561198087831260],"playerHero":["npc_dota_hero_alchemist","npc_dota_hero_puck","npc_dota_hero_warlock","npc_dota_hero_death_prophet","npc_dota_hero_rattletrap","npc_dota_hero_razor","npc_dota_hero_winter_wyvern","npc_dota_hero_tiny","npc_dota_hero_beastmaster","npc_dota_hero_bane"],"playerName":["天鸽","Abed","Fly","Nightfall 凛","Cr1t-","Tobi","Kataomi`","Stormstormer","SabeRLighT-","Fishman"],"winningTeam":3,"gameMode":2,"matchID":6701482389,"radiantTeamID":39,"direTeamID":8605863,"radiantTeamName":"EG","direTeamName":"Entity","leagueID":14417,"endTimeUTC":1660169714},
]